    ...
    <AnimatePresence>
      {showBanner && (
        <motion.div
          ...
          className="fixed bottom-20 md:bottom-4 lg:bottom-[calc(1rem+var(--app-frame-inset))] lg:right-[calc(1rem+var(--app-frame-inset-x))] left-3 right-3 md:left-auto md:right-4 md:w-96 z-[9999] rounded-2xl bg-card border border-border/50 shadow-2xl shadow-black/40 p-4"
        >
          <button
            onClick={dismiss}
