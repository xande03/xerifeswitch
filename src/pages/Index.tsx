    ...
    <MotionConfig reducedMotion="user">
      ...
      <div className={`app-frame flex bg-background overflow-hidden h-screen ${reducedMotionActive ? 'force-reduced-motion' : ''}`} style={{ height: '100dvh' }} data-theme={colorTheme}>
        ...
        <div
          ...
          className={
            playerState.isFullscreen
              ...
              : isRailMode
                ? "fixed left-0 right-0 md:left-4 md:right-[calc(var(--xerife-video-rail)+32px)] lg:left-[calc(1rem+var(--app-frame-inset-x))] lg:right-[calc(var(--xerife-video-rail)+32px+var(--app-frame-inset-x))] z-[60] top-[env(safe-area-inset-top)] md:top-[12px] lg:top-[calc(12px+var(--app-frame-inset))] bg-transparent flex items-center justify-center overflow-hidden"
        ...
        >
          ...
          {/* ILHA DE SESSÕES (desktop lg+): só as abas do módulo ativo, no
              CENTRO EXATO do app (coluna central do grid de 3 colunas do header).
              O trio de módulos (Music/Vídeos/Podcasts) foi movido para o cluster
              direito, ao lado do botão de configurações. */}
