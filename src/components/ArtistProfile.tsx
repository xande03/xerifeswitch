...
const ArtistProfile = ({ artistName, artistImage, onBack, onPlaySong, currentPlayingSong, isPlaying = false, currentTime = 0, duration = 0, onTogglePlay, onNext, onPrev, onExpand, onArtistClick }: ArtistProfileProps & { onArtistClick?: (name: string, image?: string) => void }) => {
