...
>(({ className, trackClassName, rangeClassName, thumbClassName, ...props }, ref) => (
  ...
  >
    ...
    <SliderPrimitive.Thumb className={cn("block h-5 w-5 rounded-full border-0 bg-primary shadow-[0_0_8px_hsl(var(--primary)/0.5)] ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50", thumbClassName)} />
  </SliderPrimitive.Root>
));
